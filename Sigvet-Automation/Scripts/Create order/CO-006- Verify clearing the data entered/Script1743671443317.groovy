...
//WebUI.selectOptionByValue(findTestObject('Object Repository/Page_HemaCYTE/select_SpeciesFelineCanine'), 'feline', true)
...
//WebUI.selectOptionByValue(findTestObject('Object Repository/Page_HemaCYTE/select_SpeciesFelineCanine_1'), 'canine', true)
...
//WebUI.getAttribute(findTestObject('Object Repository/Page_HemaCYTE/select_SpeciesFelineCanine_1'), '')
