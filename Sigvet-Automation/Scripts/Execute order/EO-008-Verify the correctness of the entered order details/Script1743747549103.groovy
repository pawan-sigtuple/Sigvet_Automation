...
//Panel type  selection for the slot1 cbc
...
//Panel type selection for the slot2
...
WebUI.verifyElementText(findTestObject('Object Repository/Panel type/Page_HemaCYTE/Verify RETIC selected in the slot2'), 
    'RETIC')
